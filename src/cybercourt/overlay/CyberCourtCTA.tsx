...
export const CyberCourtCTA: React.FC = () => {
  return (
    <section id="quote" className="min-h-screen w-full flex flex-col items-center justify-center text-center px-6 relative z-10 py-24 font-mono">
      <div className="max-w-3xl backdrop-blur-2xl bg-[#060911]/90 border border-[#ccff00]/50 p-10 md:p-16 rounded-none shadow-[0_0_80px_rgba(204,255,0,0.2)] relative">
        <div className="absolute -top-3 left-6 px-3 py-1 bg-[#ccff00] text-black text-xs font-black uppercase">
          CYBER DUNK // QUOTE ENGINE
        </div>
        ...
        <p className="text-zinc-300 text-sm md:text-base max-w-lg mx-auto mb-8 font-sans font-light">
          輸入球隊聯絡資訊，我們將在 24 小時內生成 Cyber Dunk 2077 專屬 3D 模擬圖與量產報價單。
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 max-w-md mx-auto">
          <input
            type="email"
            placeholder="ENTER TEAM PROTOCOL EMAIL..."
        ...
        <div className="mt-12 pt-8 border-t border-zinc-800 flex flex-wrap items-center justify-between gap-4 text-xs text-zinc-500">
          <span>© 2026 CYBER DUNK 2077 HOOP MATRIX. ALL RIGHTS RESERVED.</span>
